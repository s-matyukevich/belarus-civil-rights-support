        ...
        {type === 'phone' ? (
          <div>
            <ol>
              ...
              <li>
                Если Вы хотите чтобы автор истории смог связаться с Вами, укажите свой контакт (например емейл или
                ссылку на страницу в соц сети)
              </li>
              <li>
            ...
            <div className={layout === Layout.Mobile ? 'story-fields' : 'story-fields desctop'}>
              ...
              <Label className="bp3-inline story-field story-field--inline">
                <span className="story-field__label-text">Как связаться с Вами</span>
                <Validatable error={errors.Contact}>
                  <input
                    type="text"
                    value={model.Contact}
                    className={cn(Classes.INPUT, 'story-field__editor')}
                    onChange={evt => set('Contact', evt.target.value)}
                    placeholder=""
                  />
                </Validatable>
              </Label>
